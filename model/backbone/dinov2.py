...
class DPTHead(nn.Module):
    ...
    def compute_f2_norm_per_class(self):
        last_conv = self.scratch.output_conv[-1]
        weights = last_conv.weight 
        f2_norms = torch.norm(weights.view(weights.size(0), -1), p=2, dim=1)
